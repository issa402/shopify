...
To start the Understand Anything graph again:

  source ~/.nvm/nvm.sh
  nvm use 22

  cd /home/iscjmz/.understand-anything/repo/understand-anything-plugin/
  packages/dashboard

  GRAPH_DIR=/home/iscjmz/shopify/shopify/Pokemon npx vite --host
  127.0.0.1

  It will print a URL like:

  🔑 Dashboard URL: http://127.0.0.1:5174/?token=...

  Use the URL with the ?token=.... Without the token, the dashboard
  will block you.

  To refresh the graph before opening it, ask:

  Use the understand skill on /home/iscjmz/shopify/shopify/Pokemon
  --full --auto-update
